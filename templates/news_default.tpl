<script type="text/javascript">
	...
	/*		function formsubmit() {
				rootweb=$('#rootweb').val();
				var link=rootweb+'/plugins/plg_news/newsAjax.php';
...
<section class="news-area news-area-edit page-top">
	<div class="container">
		...
		<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 itemheight mb-6">
			<a href="{$data.news_all[pom].link_print_dt}">
	    <div class="news-group-box">
				<div class="slika" style="background-image:url({$ROOT_WEB}{$data.news_all[pom].slika})">

	    	</div>
				<div class="news-content">
					<h5>{$data.news_all[pom].header}</h5>

...
{literal}
	...
	function pt_cleaner() {
	var link = window.folder+'/pt_cleaner.php';
      $.ajax({
        url:link,
...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		<div class="html5buttons">
			...
			<div class="dt-buttons btn-group">
				<div class="btn btn-default buttons-excel buttons-html5" tabindex="0" aria-controls="DataTables_Table_0" onclick="pt_cleaner()"><span>Plugin Template Cleaner</span></div>
			</div>
		</div>

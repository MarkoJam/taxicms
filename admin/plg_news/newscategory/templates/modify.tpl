...
<div id="content">
	<form  id='inner' action="modify_final.php" method="post" enctype="multipart/form-data" >
				...
				<div class="panel-body">
                    <fieldset class="form-horizontal">
						...
						<div class="form-group"><label class="col-sm-2 control-label">{$PLG_NUMBER}</label>
                            <div class="col-sm-10">
								<input name="brojVestiKategorije" type="text" value="{$brojVestiKategorije}" id="brojVestiKategorije" class="form-control" placeholder="{$PLG_NUMBER_NEWS}">
							</div>
                        </div>
					</fieldset>
				</div>
		...
		<input name="newscategoryid" type="hidden" id="newscategoryid" value="{$newscategoryid}">
	</form>
</div>

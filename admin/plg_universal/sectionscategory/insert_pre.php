<?  
	...
	if($auth->isActionAllowed("ACTION_SECTIONS_CATEGORY_CREATE"))
	{
		$nc = $ObjectFactory->createObject("SectionsCategory",-1);
		$nc->Title = $LanguageArray["value"]["PLG_SECTIONS_CATEGORY_INSERT_NEW"];
		$nc->MessageNum = 10;
		$nc->Status = "online";

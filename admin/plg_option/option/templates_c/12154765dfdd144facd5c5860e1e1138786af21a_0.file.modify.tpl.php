<?php
/* Smarty version 3.1.32, created on 2023-08-08 11:42:02
  from 'C:\wamp\www\taxicms\admin\plg_option\option\templates\modify.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_64d20dea0f0b02_49680202',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '12154765dfdd144facd5c5860e1e1138786af21a' => 
    array (
...
function content_64d20dea0f0b02_49680202 (Smarty_Internal_Template $_smarty_tpl) {
                            ...
                            <div class="panel-body">
                                <fieldset class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-2 control-label"><?php echo $_smarty_tpl->tpl_vars['PLG_KEYWORDS']->value;?>
                                        ...
                                        <div class="col-sm-10"><input type="text" id='title' name="keywords" value="<?php echo $_smarty_tpl->tpl_vars['keywords']->value;?>
...
"></div>
									...
									<div class="form-group"><label class="col-sm-2 control-label"><?php echo $_smarty_tpl->tpl_vars['PLG_PLACE']->value;?>
</label>
										<div class="col-sm-10"><input type="text" name="place" value="<?php echo $_smarty_tpl->tpl_vars['place']->value;?>
" class="form-control" placeholder="<?php echo $_smarty_tpl->tpl_vars['PLG_PLACE']->value;?>
"></div>
									</div>
...
">
									...
									<div class="form-group"><label class="col-sm-2 control-label"><?php echo $_smarty_tpl->tpl_vars['PLG_CATEGORY']->value;?>
										...
										<div class="col-sm-10">
											<div>
											<select size="5" multiple="multiple" name="optioncategories[]" class="chosen-select">
												<?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['optioncategory_val']->value,'selected'=>$_smarty_tpl->tpl_vars['optioncategory_sel']->value,'output'=>$_smarty_tpl->tpl_vars['optioncategory_out']->value),$_smarty_tpl);?>
...
">
									...
									<div class="form-group"><label class="col-sm-2 control-label"><?php echo $_smarty_tpl->tpl_vars['PLG_DURATION']->value;?>
</label>
										<div class="col-sm-1"><input type="text" name="duration" value="<?php echo $_smarty_tpl->tpl_vars['duration']->value;?>
" class="form-control" placeholder="<?php echo $_smarty_tpl->tpl_vars['PLG_DURATION']->value;?>
"></div>
									</div>									
									<div class="form-group"><label class="col-sm-2 control-label"><?php echo $_smarty_tpl->tpl_vars['PLG_LINK']->value;?>
</label>
										<div class="col-sm-10"><input type="text" name="link" value="<?php echo $_smarty_tpl->tpl_vars['link']->value;?>
...
" size="50" class="form-control image">
										</div>
										<div class="col-sm-2">

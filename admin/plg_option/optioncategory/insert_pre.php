<?  
	...
	if($auth->isActionAllowed("ACTION_OPTION_CATEGORY_CREATE"))
	{
		$nc = $ObjectFactory->createObject("OptionCategory",-1);
		$nc->Title = $LanguageArray["value"]["PLG_OPTION_CATEGORY_INSERT_NEW"];
		$nc->MessageNum = 10;
		$nc->Status = "online";

...
CKEDITOR.plugins.add( 'widgetbootstrap', {
    ...
    icons: 'widgetbootstrapLeftCol,widgetbootstrapRightCol,widgetbootstrapTwoCol,widgetbootstrapThreeCol,widgetbootstrapFourCol,widgetbootstrapAlert',
		...
		editor.widgets.add( 'widgetbootstrapFourCol', {
            ...
            template:
                '<div class="row four-col">' +
                    '<div class="col-md-3 col-1"><p><img src="http://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
                    '<div class="col-md-3 col-2"><p><img src="http://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
                    '<div class="col-md-3 col-3"><p><img src="http://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
					'<div class="col-md-3 col-4"><p><img src="http://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>' +
                '</div>',

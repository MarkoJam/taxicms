...
if(!isset($_SESSION["RESPONSIVE"]["UKLJUCEN"]) == "DA"){
		die('Access Denied - nije ukljucen!');
	}
...
// Ovo ide ako je descending default
...
if (isset($_GET["descending"])) {
	...
	// Ovo ide ako je ascending default
	if (!isset($_SESSION['RF']['descending'])) {
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/fileupload.min.css">
...
<body>
    <script src="js/main-body.min.js"></script>

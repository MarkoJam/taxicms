...
$config = array(
    ...
    */
    ...
    'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt'), //Files
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '/thumb200/', '/thumb400/' , '/thumb600/'), //fixed path of the image folder from the current position on upload folder
    'fixed_image_creation_name_to_prepend'    => array( 'thumb_200_', 'thumb_400_', 'thumb_600_' ), //name to prepend on filename
    'fixed_image_creation_to_append'          => array( '', '', '' ), //name to appendon filename
    'fixed_image_creation_width'              => array( 200, 400, 600 ), //width of image
    'fixed_image_creation_height'             => array( 200, 400, 600 ), //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    #                          4 / crop= resize and crop;
    */
    'fixed_image_creation_option'             => array( 'crop', 'auto', 'auto' ), //set the type of the crop
    ...
    'relative_path_from_current_pos'          => array( './thumb260x200/', './thumb400/', './thumb600/' ), //relative path of the image folder from the current position on upload folder
    'relative_image_creation_name_to_prepend' => array( '', '', '' ), //name to prepend on filename
    'relative_image_creation_name_to_append'  => array( '_thumb260', '_thumb400', '_thumb600' ), //name to append on filename
    'relative_image_creation_width'           => array( 260, 400, 600 ), //width of image
    'relative_image_creation_height'          => array( 200, '','' ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
     ...
     *              4 / crop= resize and crop;
     */
    'relative_image_creation_option'          => array( 'crop', 'auto', 'auto' ), //set the type of the crop

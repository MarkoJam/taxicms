						 ...
						 <fieldset class="form-horizontal">
                              <div class="row">
								...
								<div class="row">
									...
									<div class="col-md-9">
										<p class="form-control-static">{$name} {$surname}</p>
									</div>
								</div>
								<div class="row">
                                    <label class="col-sm-3 control-label">
									...
									<div class="col-md-9">
										<p class="form-control-static">{$company} - {$pib}</p>
									</div>
								</div>
								<div class="row">
                                    <label class="col-sm-3 control-label">
								...
								<div class="row">
									...
									<div class="col-md-9">
										<p class="form-control-static">{$postalcode}</p>
									</div>
								</div>
								<div class="row">
                                    <label class="col-sm-3 control-label">
								...
								<div class="row">
									...
									<div class="col-md-9">
										<p class="form-control-static"><a href="mailto:{$email}">{$email}</a></p>
									</div>
								</div>
								<div class="row">
                  <label class="col-sm-3 control-label">
									...
									<div class="col-md-9">
										<p class="form-control-static">Ime i prezime: {$name} {$surname} <br>
									Adresa:	{$shipaddress} <br>
									Mesto:   {$shipcity} <br>
									Poštanski broj:		{$shippostalcode} <br>
									Država:   {$shipcountry} <br>
									Telefon:		{$phone} <br>
									E-mail:	{$email} <br> </p>
									</div>
								</div>
									...
									<div class="table-responsive">
										<table  border="0" cellspacing="0" class="table table-striped table-bordered table-hover dataTables-example dataTable">
											...
											<tr>
												...
												<td>{$orderitem_proiz_cene[cnt]} EUR</td>
												<td class="right">{$orderitem_proiz_iznosi[cnt]} EUR</td>
											</tr>
											{/section}
											<tr>
											<TD colspan="5"><b>{$PLG_TOTAL}</b></TD>
											<td class="right"><strong> {$orderitem_proiz_ukupna_cena} EUR</strong> </td>
											</tr>
										</table>
									</div>
								</div>

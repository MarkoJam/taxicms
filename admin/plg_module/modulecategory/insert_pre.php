<?  
	...
	if($auth->isActionAllowed("ACTION_MODULE_CATEGORY_CREATE"))
	{
		$nc = $ObjectFactory->createObject("ModuleCategory",-1);
		$nc->Title = $LanguageArray["value"]["PLG_MODULE_CATEGORY_INSERT_NEW"];
		$nc->MessageNum = 10;
		$nc->Status = "online";

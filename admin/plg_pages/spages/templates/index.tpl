	...
	<div class="ibox-content">
		<div class="html5buttons">
			<div class="dt-buttons btn-group">
					<a class="btn btn-success buttons-html5" tabindex="0" href="modify_grp.php?mode='insert'">
						<i class="fa fa-file-text-o" ></i> <span>{$PLG_ADD} / {$PLG_PAGES}</span>
					</a>
					<a class="btn btn-success buttons-html5" tabindex="0"  href="modify_link.php?mode='insert'">

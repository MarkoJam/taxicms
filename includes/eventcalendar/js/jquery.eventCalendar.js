					...
					if (limit === 0 || limit > i) {
						...
						if ((month === false || month == eventMonth) && (day === '' || day == eventDay) && (year === '' || year == eventYear) ) {
								...
								if (month === false && eventDate < new Date()) {
									...
									eventStringDate = moment(eventDate).format(eventsOpts.dateFormat);
								//	eventStringMonthToShow = moment(eventMonthToShow).format("MMMM");
									formatedMonth= moment(eventMonthToShow, "MM").format("MMMM");
									var eventTitle;
									...
									events.push('<li id="' + key + '" class="'+event.type+'"><time datetime="'+eventDate+'"><div class="day">' + eventDay + '</div><div class="month">' + formatedMonth + '</div><small>'+eventHour+":"+eventMinute+'</small></time>'+eventTitle+'<p class="eventCalendar-eventDesc ' + eventDescClass + '">' + event.description + '</p></li>');
									i++;
								}
						}
					}

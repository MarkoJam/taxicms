...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		var panelElm = new bkElement('DIV').setStyle({width : (parseInt(e.getStyle('width')) || e.clientWidth)+'px'}).addClass('nicewrap').appendBefore(e);
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			this.editorContain = new bkElement('DIV').setStyle(s).addClass('box').appendBefore(e);

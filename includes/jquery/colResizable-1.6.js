...
(function($){ 	
	...
	var init = function( tb, options){	
		...
		t.id = t.id + '-' + window.folder; 					//for diferent session variable for diferent tables with same id
